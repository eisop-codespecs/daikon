...
ifndef NONETWORK
	if test -d utils/plume-scripts/.git ; then \
	  ...
	  (mkdir -p utils && (git clone -q --depth 1 https://github.com/eisop-plume-lib/plume-scripts.git utils/plume-scripts || (sleep 1m && git clone -q --depth 1 https://github.com/eisop-plume-lib/plume-scripts.git utils/plume-scripts))) \
	fi
endif
