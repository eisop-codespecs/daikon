...
ifndef NONETWORK
	if test -d utils/checklink/.git ; then \
	  ...
	  (mkdir -p utils && (git clone -q --depth=1 https://github.com/eisop-plume-lib/checklink.git utils/checklink || (sleep 1m && git clone -q --depth=1 https://github.com/eisop-plume-lib/checklink.git utils/checklink))) \
	fi
endif
...
ifndef NONETWORK
	if test -d utils/git-scripts/.git ; then \
	  ...
	  (mkdir -p utils && (git clone -q --depth=1 https://github.com/eisop-plume-lib/git-scripts.git utils/git-scripts || (sleep 1m && git clone -q --depth=1 https://github.com/eisop-plume-lib/git-scripts.git utils/git-scripts))) \
	fi
endif
...
ifndef NONETWORK
	if test -d utils/plume-scripts/.git ; then \
	  ...
	  mkdir -p utils && (git clone -q --depth=1 --depth 1 https://github.com/eisop-plume-lib/plume-scripts.git utils/plume-scripts || (sleep 1m && git clone -q --depth=1 --depth 1 https://github.com/eisop-plume-lib/plume-scripts.git utils/plume-scripts)) \
	fi
endif
...
ifndef NONETWORK
	if test -d utils/run-google-java-format/.git ; then \
	  ...
	  (mkdir -p utils && (git clone -q --depth=1 https://github.com/eisop-plume-lib/run-google-java-format.git utils/run-google-java-format || (sleep 1m && git clone -q --depth=1 https://github.com/eisop-plume-lib/run-google-java-format.git utils/run-google-java-format))) \
	fi
endif
